# This script is to visualize depth maps but convert to disparity maps firstly.
...
def convert_array_to_pil(name):
    ...
    vmax = np.percentile(disp_map, 70)
...
if __name__ == '__main__': 
    origin_disp_dir = './SQLdepth_unsuper_320x1024/'
    all_disps = glob.glob(origin_disp_dir + '/*.png')
    output_disp_dir = './SQLdepth_unsuper_320x1024_disp/'
